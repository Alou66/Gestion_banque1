...
#     echo "DB_HOST=dpg-d417lgh5pdvs73c0l370-a.oregon-postgres.render.com" >> .env && \
#     echo "DB_PORT=5432" >> .env && \
#     echo "DB_DATABASE=laravel_zmei" >> .env && \
#     echo "DB_USERNAME=laravel" >> .env && \
#     echo "DB_PASSWORD=3lrJv6O0ZCFdmAWBr8OagzxnkXxtv8Ds" >> .env && \
#     echo "" >> .env && \
